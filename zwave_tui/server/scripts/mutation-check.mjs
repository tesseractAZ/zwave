...
const MUTANTS = [
  ...
  { id: 'entry-reload-latched', file: 'src/zwave/zwaveData.ts', tests: ['zwaveDataChurn'],
    find: '      if (entryReloading) this.entryReloadSeen = true;',
    repl: '',
  ...
  { id: 'rearm-releases-the-orphans', file: 'src/zwave/zwaveData.ts', tests: ['zwaveDataChurn'],
    find: '    for (const sub of this.ownedStatsSubs.splice(0)) await sub.unsubscribe().catch(() => {});',
    repl: '    this.ownedStatsSubs.splice(0);',

...
const MUTANTS = [
  ...
  { id: 'confounded-tag-renders', file: 'src/zwave/outcomes.ts', tests: ['outcomes'],
    // Re-pointed in v0.71.0: a re-route by our own read is a named cause.
    find: "          ? ' (confounded \u2014 the node died, was remediated, or was re-routed by our own probe mid-episode; credited to neither arm)'",
    repl: "          ? ''",
